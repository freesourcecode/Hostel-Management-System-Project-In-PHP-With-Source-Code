						   ...
						   <form  method="POST" action="#.php">
								<div class="col-xs-12 col-sm-12">
						            ...
						            <div class="form-group">
						            	<div class="row">
					            			<div class="col-xs-12 col-sm-12">
						           				 <button type="submit" class="btn btn-success" align="right"name="avail">Check Availability</button>
						           			 </div>
						            	</div>
						            </div>
						        </div>
						   ...
						   <form  method="POST" action="#.php">
								<div class="col-xs-12 col-sm-12">
						            ...
						            <div class="form-group">
						            	<div class="row">
					            			<div class="col-xs-12 col-sm-12">
						           				 <button type="submit" class="btn btn-success" align="right" name="login">Sign in</button>
						           			 </div>
						            	</div>
						            </div>
						        </div>
