...
<title>Jude Guest's House: <?php echo $title; ?></title>
...
<body>
<!--Header-->
	    <div class="navbar navbar-fixed-top navbar-inverse" style="background-color: darkblue" role="navigation">
	      <div class="container">
	        <div class="navbar-header">
	          ...
	          <a class="navbar-brand" href="<?php echo WEB_ROOT; ?>index.php">Jude Guest's House</a>
	        </div>
				...
				<!-- <img  width="1100px" hieght="100px" class="img-rounded"/> -->
					<div class="media">
					  <a class="pull-left" href="#">
					    <img class="media-object" src="<?php echo WEB_ROOT; ?>img/hotel.jpg" alt="...">
					  </a>
					</div>
				</div>
			</div>
